...
class ExtractData:
    ...
    def extractVehicles(self):
        ...
        for vehicle_data in data["vehicles"]:
            vehicles.append(Vehicle(vehicle_data["id"],
                                    vehicle_data["canTake"],
                                    vehicle_data["start"],
                                    vehicle_data["end"],
    ...
    def extractPatients(self):
        ...
        for patient_data in data["patients"]:
            patients.append(Patient(patient_data["id"],
                                    patient_data["category"],
                                    patient_data["load"],
                                    patient_data["start"],
    ...
    def extractLocations(self):
        ...
        for place_data in data["places"]:
            places.append(Location(place_data["id"],
                                   place_data["lat"],
                                   place_data["long"],
                                   place_data["category"]))
